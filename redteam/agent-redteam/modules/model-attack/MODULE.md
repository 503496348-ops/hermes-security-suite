...
- 用户明确希望复用 [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/eval/` 做模型 benchmark。
...
[AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/eval/` 中包含多类公开 benchmark 样本，例如 privacy-leakage、cyberattack、misinformation、violent、CBRN 等。默认不要全量发送这些 prompt。

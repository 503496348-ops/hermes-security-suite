...
- 规范化并探测 URL。
- 优先匹配 [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/fingerprints/`，找不到时回退内置指纹。
- 在指纹支持时提取版本。
- 如果存在 [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/vuln/` 或 `data/vuln_en/`，匹配 CVE/漏洞规则。
...
- [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/fingerprints/`：首选 AI 基础设施指纹数据源。
- [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/vuln/`：首选中文漏洞规则数据源。
- [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/vuln_en/`：英文漏洞规则数据源，可通过 `--vuln-lang en` 使用。

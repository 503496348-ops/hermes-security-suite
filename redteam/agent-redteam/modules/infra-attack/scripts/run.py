...
def main():
    ...
    ap.add_argument("--aig-data-dir", help="AtomGuard/data 路径")
    ap.add_argument("--aig-root", help="AtomGuard 仓库根目录")
    ap.add_argument("--download-aig-data", action="store_true", help="未找到本地 AIG data 时下载 AtomGuard 到临时目录")
    ap.add_argument("--aig-repo", default=os.environ.get("AIG_REPO", "https://github.com/503496348-ops/hermes-security-suite.git"))

...
只复用 [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) 的 `data/`，不要把 AIG 扫描器执行逻辑并入蓝军流程。
...
- 数据集优先来自 [AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite) `data/eval/`、本 skill `modules/model-attack/data/eval_datasets/` 或用户授权样本。

...
- 报告中必须突出 AIG 数据来源。
- HTML 中提到 AtomGuard 时使用可点击链接：
  `<a href="https://github.com/503496348-ops/hermes-security-suite" target="_blank" rel="noopener noreferrer">AtomCollide-智械工坊/hermes-security-suite</a>`。
- Markdown 中使用 `[AtomCollide-智械工坊/hermes-security-suite](https://github.com/503496348-ops/hermes-security-suite)`。

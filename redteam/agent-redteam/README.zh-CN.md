# A.G Agent 护网 — 一句话给 Agent 做安全演习

[English](./README.md)

面向 AI Agent 的全方位红队安全演习技能。装进你的 Agent 客户端，让它以攻击者视角攻击自己——测试提示词注入、间接注入、工具滥用、数据泄露、权限提升、SSRF、供应链风险、基础设施暴露等全攻击面。

基于AtomCollide-智械工坊 [A.G](https://github.com/503496348-ops/atomguard) 的第一性原理蓝军方法论。
...
扫描能力由AtomCollide-智械工坊 [A.G](https://github.com/503496348-ops/atomguard) 提供

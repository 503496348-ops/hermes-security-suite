# A.G Agent Red Team — Agent Security Assessment in One Command
...
Powered by first-principles red-team methodology from [AtomCollide-智械工坊 A.G](https://github.com/503496348-ops/atomguard).
...
```text
https://github.com/503496348-ops/atomguard/tree/main/skills/aig-agent-redteam
```
...
```bash
git clone https://github.com/503496348-ops/atomguard.git /tmp/aig
...
Powered by AtomCollide-智械工坊 [A.G](https://github.com/503496348-ops/atomguard)

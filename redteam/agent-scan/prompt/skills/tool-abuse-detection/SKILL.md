...
**Verification target**:
- URL: `https://tencent.github.io/AtomGuard/ssrf.html`
...
**Testing strategy**:
1. Use `dialogue(prompt="...")` with the above templates, replacing `{url}` with `https://tencent.github.io/AtomGuard/ssrf.html`

...
class RedTeamRunner:
    ...
    def run_red_team(
        ...
        logger.status_update(statusUpdate(stepId="3", brief=logger.translated_msg("A.G is working"), description=logger.translated_msg("Generating report"), status="running"))
        ...
        logger.status_update(statusUpdate(stepId="3", brief=logger.translated_msg("A.G is working"), description=logger.translated_msg("Generating report"), status="completed"))

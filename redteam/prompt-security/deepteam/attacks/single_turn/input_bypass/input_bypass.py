...
class InputBypass(BaseAttack):
    ...
    def enhance(self, attack: str) -> str:
        ...
        if judge_language(attack) == "chinese":
            enhancement_methods = [
                InputBypassTemplate.enhance_exception_handling_zh,
                InputBypassTemplate.enhance_compliance_adaptation_zh,
                InputBypassTemplate.enhance_security_override_zh,
                InputBypassTemplate.enhance_operational_necessity_zh,
                InputBypassTemplate.enhance_emergency_bypass_zh,
                InputBypassTemplate.enhance_universal_exemption_zh,
            ]
        else:
            enhancement_methods = [

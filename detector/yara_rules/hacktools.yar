/*
    奇点造物-Genesisix · Hack Tool & Exploit Detection YARA Rules
    AtomCollide-智械工坊 · 2026

    Detects references to offensive security tools, exploit frameworks,
    network reconnaissance, privilege escalation tools, and phishing kits.
    Based on Neo23x0/signature-base and community research.
*/
